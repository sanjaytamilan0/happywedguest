...
class AdvanceInvitationScreen extends StatefulWidget {
  final bool isPreview;
  const AdvanceInvitationScreen({super.key, this.isPreview = false});

  @override
  State<AdvanceInvitationScreen> createState() => _AdvanceInvitationScreenState();
}

class _AdvanceInvitationScreenState extends State<AdvanceInvitationScreen> with SingleTickerProviderStateMixin {
          ...
          if (mounted) {
            if (widget.isPreview) {
              Navigator.of(context).pushReplacement(
                PageRouteBuilder(
                  pageBuilder: (context, animation, secondaryAnimation) => AdvanceReceptionScreen(isPreview: widget.isPreview),
